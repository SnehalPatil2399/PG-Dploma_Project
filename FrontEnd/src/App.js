...
class App extends Component{
  constructor(props){
    ...
    this.logout=this.logout.bind(this);
     //To maintain the correct context of this, the bind method is used here.
   //It binds the method this.logout to the current instance of the component,
   // ensuring that when this.logout is called, 
   //it has access to the component's properties and state.
    this.state = {
      //1==login 0==not login
      auth:false,
    };
  ...
  {
    alert("logout");
    authService.logout(); //for localstorage clear
  }
